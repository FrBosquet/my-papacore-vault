    ...
    <div>
      {songs
        ...
        .map((song) => {
          return (
            <div
              className="flex gap-2 hover:bg-primary-700"
              key={song.page.$id}
            >
              <img
                src={song.albumImage}
              ...
              <a
                href={song.albumUrl}
                className="no-underline text-theme-contrast"
              >
                {song.songTitle}
              </a>
              ...
              {song.songComment ? (
                <button
                  type="button"
                  aria-label={song.songComment}
                  className="bg-transparent border-none outline-none shadow-none w-auto flex- cursor-help"
                >
                  <dc.Icon icon="info" />
                </button>
              ) : null}
