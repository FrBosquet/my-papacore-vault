...
export const ProjectsWidget = () => {
  ...
  return (
    <Card>
      <Link path="Projects/Hub.base" icon="folder-kanban">
        Working on
      </Link>
      <Scroller
        className="h-30 @container w-full"
        wrapperClassName="gap-2 grid grid-cols-2 @[540px]:grid-cols-3"
      >
    ...
    >
      <div>
        ...
        <p className="text-primary-600">
          (<span>{backlog}</span>|
          <span
            data-danger={thisWeek > 0}
            className="data-[danger=true]:text-orange-700"
          >
            {thisWeek}
          </span>
          |<span>{ongoing}</span>|
