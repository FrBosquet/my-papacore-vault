...
const outputPath = path.join(__dirname, '../src/icons.d.ts')
...
try {
  ...
  const content = `// Auto-generated by scripts/generate-icons.js
...
`
  ...
  console.log(`Generated ${iconNames.length} icon types in src/icons.d.ts`)
} catch (error) {
